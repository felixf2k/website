...
<div class="flex h-full w-full grow flex-col items-center justify-center content pt-16 select-none">
	<div class="flex max-w-full flex-col items-center gap-8">
		<CircleCheckBig class="h-32 w-32 text-primary-500" />
